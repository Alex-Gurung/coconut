...
# for run in 4; do
    ...
    # sed -i "s|load_model_path: \".*/checkpoint_[0-9]*\"|load_model_path: \"/mnt/disk/coconut/checkpoints/qwen-coconut-v4/checkpoint_14\"|" args/legacy/qwen_coconut_ncpeval_v4.yml 
    sed -i \
